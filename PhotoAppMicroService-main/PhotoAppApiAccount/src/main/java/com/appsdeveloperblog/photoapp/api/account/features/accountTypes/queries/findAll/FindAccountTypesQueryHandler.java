...
@Component //belleğe yerleşsin diye
...
//Scaling--MIKRO SERVISE GELEN YUKU FARKLI SERVERLARA DAGITMAKTIR(BUNUN ICIN "KuberNates" KULLANILIR)

/*
 * ODEVLER VE ARASTIRMA KONULARI *
 * LAMBDA EXPRESSIONS
 * STREAM API --> KONUSU ARAŞTIRILARAK YARIN İÇİN SUNUM HAZIRLANACAK...
 * JAVA MULTIHREADING & CONCURENCY 
 * * * * * * * * * * * * * * * * *
 * TAKVIM *
 * SQL MODELLEME - CARSAMBA-PERSEMBE-CUMA
 * PAZARTESI ITIBARI ILE MONOLITH, KLASIK MIMARI PROJESI OLAN RENT A CAR'A GERI DONUS
 * */
